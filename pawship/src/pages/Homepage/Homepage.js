  ...
  return (
    <div className="homepage">
      ...
      <div className="content">
        ...
        <ol>
          <li><strong>Stöbern:</strong> Sieh dir die verfügbaren Tiere auf unserer Seite an.</li>
          <li><strong>Verlieben:</strong> Finde das Tier, das perfekt zu dir passt.</li>
          <li><strong>Adoptieren:</strong> Wir helfen dir bei jedem Schritt, um sicherzustellen, dass dein neuer Begleiter sich bei dir wohlfühlt.</li>
        </ol>
      </div>
    </div>
  );
